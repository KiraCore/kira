...
# 10.1.0.0/16
# 
KIRA_DOCEKR_SUBNET="172.17.0.0/16"         && setGlobEnv KIRA_DOCEKR_SUBNET "$KIRA_DOCEKR_SUBNET" 
KIRA_DOCEKR_NETWORK="bridge"         && setGlobEnv KIRA_DOCEKR_NETWORK "$KIRA_DOCEKR_NETWORK" 
