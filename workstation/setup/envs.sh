...
KIRA_VALIDATOR_DNS="validator.local"    && globSet KIRA_VALIDATOR_DNS "$KIRA_VALIDATOR_DNS" 
KIRA_SENTRY_DNS="sentry.local"          && globSet KIRA_SENTRY_DNS "$KIRA_SENTRY_DNS" 
KIRA_SEED_DNS="seed.local"              && globSet KIRA_SEED_DNS "$KIRA_SEED_DNS" 
KIRA_INTERX_DNS="interx.local"          && globSet KIRA_INTERX_DNS "$KIRA_INTERX_DNS" 
