...
DEFAULT_GRPC_PORT="9090"                && globSet DEFAULT_GRPC_PORT "$DEFAULT_INTERX_PORT"
DEFAULT_DOCKER_SUBNET="10.1.0.0/16"     && globSet DEFAULT_DOCKER_SUBNET "$DEFAULT_INTERX_PORT"
DEFAULT_DOCKER_NETWORK="kiranet"        && globSet DEFAULT_DOCKER_NETWORK "$DEFAULT_INTERX_PORT"
