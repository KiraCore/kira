...
KIRA_REGISTRY_SUBNET="10.1.0.0/16"      && setGlobEnv KIRA_REGISTRY_SUBNET "$KIRA_REGISTRY_SUBNET" 
KIRA_SENTRY_SUBNET="10.2.0.0/16"        && setGlobEnv KIRA_SENTRY_SUBNET "$KIRA_SENTRY_SUBNET" 
KIRA_SERVICE_SUBNET="10.3.0.0/16"       && setGlobEnv KIRA_SERVICE_SUBNET "$KIRA_SERVICE_SUBNET" 

KIRA_REGISTRY_NETWORK="regnet"          && setGlobEnv KIRA_REGISTRY_NETWORK "$KIRA_REGISTRY_NETWORK" 
KIRA_SENTRY_NETWORK="sentrynet"         && setGlobEnv KIRA_SENTRY_NETWORK "$KIRA_SENTRY_NETWORK" 
KIRA_INTERX_NETWORK="servicenet"        && setGlobEnv KIRA_INTERX_NETWORK "$KIRA_INTERX_NETWORK" 

#KIRA_REGISTRY_DNS="registry.local"      && setGlobEnv KIRA_REGISTRY_DNS "$KIRA_REGISTRY_DNS" 
...
KIRAMGR_SCRIPTS="$KIRA_MANAGER/scripts"                         && setGlobEnv KIRAMGR_SCRIPTS "$KIRAMGR_SCRIPTS"
