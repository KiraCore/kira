...
echo "INFO: Ensuring UFW rules persistence & stopping docker"
...
firewall-cmd --permanent --zone=$ZONE --add-rich-rule="rule family=\"ipv4\" source address=\"$KIRA_VALIDATOR_SUBNET\" port port=\"1-65535\" protocol=\"tcp\" accept"
firewall-cmd --permanent --zone=$ZONE --add-rich-rule="rule family=\"ipv4\" source address=\"$KIRA_SENTRY_SUBNET\" port port=\"1-65535\" protocol=\"tcp\" accept"
firewall-cmd --permanent --zone=$ZONE --add-rich-rule="rule family=\"ipv4\" source address=\"$KIRA_SERVICE_SUBNET\" port port=\"1-65535\" protocol=\"tcp\" accept"
