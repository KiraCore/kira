...
```
UPGRADE_NAME_TMP="upgrade-102" && UPGRADE_TIME=$(($(date -d "$(date)" +"%s") + 900)) && \
INFRA_RES_TMP="{\"id\":\"kira\",\"git\":\"https://github.com/KiraCore/kira\",\"checkout\":\"latest\",\"checksum\":\"\"}" && \
